...
public class doaobjmatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doaobjmat);
...
// recebe o botão de opção selecionado do radioGroup
                ...
                Toast.makeText(doaobjmatActivity.this, radioEntrega.getText(), Toast.LENGTH_SHORT).show();
            }
        });
    }
